                    ...
                    <div className="product-details" data-sticky-options="{'minWidth': 767}">
                      ...
                      <div className="product-bm-wrapper">
                        <figure className="brand">
                          <img src={"https://baybridgebd.com/upload/" + JSON.parse(proDetails.img)} alt="Brand" width={85} height={48} />
                        </figure>
                      ...
                      <div className="fix-bottom product-sticky-content sticky-content">
                        <div className="product-form container">
                          <button className="btn btn-primary " onClick={() => cartUpdate(proDetails)}>
