                  ...
                  <div className="vendor-details">
                    ...
                    <div className="vendor-personal">
                      <h4 className="vendor-name">
                        <a href="vendor-dokan-store.html">{item.name}</a>
                      </h4>
                      <h4 className="vendor-name">
                        <a href="vendor-dokan-store.html">{item.email}</a>
                      </h4>
...
export async function getServerSideProps(context) {
  const { data: vendor } = await axios.get(process.env.API_URL + "/GetVendorInfo");
