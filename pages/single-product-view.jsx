                ...
                <div className="product product-single row">
                      ...
                      >
                        <div className="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/1-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/2-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/3-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/4-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/5-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/6-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/7-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/8-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/9-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/10-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/11-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/12-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/13-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                          <div className="product-thumb swiper-slide">
                            <img src="assets/images/products/swatch/14-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                          </div>
                        </div>
                        <button className="swiper-button-next" />
                        <button className="swiper-button-prev" />
                  ...
                  <div className="col-md-6 mb-6 mb-md-8">
                    <div className="product-details" data-sticky-options="{'minWidth': 767}">
                      <h1 className="product-title">Fashion Table Sound Marker</h1>
                      <div className="product-bm-wrapper">
                        <figure className="brand">
                          <img src="assets/images/products/brand/brand-6.jpg" alt="Brand" width={85} height={48} />
                        </figure>
                      ...
                      <div className="product-price">$30.00 - $40.00</div>
                    ...
                    <div className="tab-pane active" id="product-tab-description">
                      <div className="row mb-4">
                        <div className="col-md-6 mb-5">
                          ...
                          <p className="mb-4">
                            Lorems ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt arcu cursus vitae congue mauris. Sagittis
                            id consectetur purus ut. Tellus rutrum tellus pelle Vel pretium lectus quam id leo in vitae turpis massa.
                          </p>
