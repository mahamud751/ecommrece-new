...
$.extend($.easing, {
        ...
        (Wolmart.$window = t(window)),
            ...
            (Wolmart.setProgressBar = function (e) {
                Wolmart.$(e).each(function () {
                    ...
                    -1 != i.indexOf("%")
                        ? (a = i)
                        : -1 != i.indexOf("/") && (a = (a = (parseInt(i.split("/")[0]) / parseInt(i.split("/")[1])) * 100).toFixed(2).toString() + "%"),
    ...
    (function (t) {
        ...
        var i = function (t) {
            ...
            if (
                (i.match(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g) &&
                    e.setAttribute("class", i.replace(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g, "").replace(/\s+/, " ")),
        ...
        (e.defaults = { slidesPerView: 1, speed: 300 }),
            (e.presets = {
                "product-thumbs-wrap": { slidesPerView: 4, spaceBetween: 10, freeMode: !0, watchSlidesVisibility: !0, watchSlidesProgress: !0, freeModeSticky: !0 },
            }),
        ...
        (e.prototype.init = function (e) {
            ...
            (o.$wrapper = e),
                ...
                (s.parent().hasClass("product-gallery-video") &&
                    (o.isQuickView ||
                        s.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>'),
                        o.isQuickView ||
                        s.append('<a href="#" class="product-gallery-btn product-video-viewer" title="Product Video Thumbnail"><i class="w-icon-movie"></i></a>'))),
    ...
    (function (t) {
            ...
            if (
                ...
                if ("undefined" != typeof PhotoSwipe) {
                    ...
                    if ("rtl" == Wolmart.$body.attr("dir"))
                        var d = new PhotoSwipe(c, PhotoSwipeUI_Default, a, { index: l, closeOnScroll: !1, showAnimationDuration: 0, rtl: !0 });
        ...
        function i(t) {
            t.preventDefault(),
                Wolmart.popup(
                    { items: { src: '<video src="assets/video/memory-of-a-woman.mp4" autoplay loop controls>', type: "inline" }, mainClass: "mfp-video-popup" },
                    "video"
                );
        }
        function a(e) {
                ...
                (function (e) {
                    ...
                    function o() {
                        i.hasClass("fix-top") && window.innerWidth > 767 && i.removeClass("fix-top").addClass("fix-bottom"),
                            ...
                            (i.hasClass("fix-bottom") && window.innerWidth < 768 && i.removeClass("fix-bottom").addClass("fix-top"),
